...
impl Car {
    ...
    fn set_car_info_with_self(
        ...
        self.log_after_set_method("set_car_info_with_self");
    }
    ...
    fn log_after_set_method(&self, called_from: &str) {
        println!("\n----- after calling {} -----", called_from);
        println!("using self:\n{:#?}", self);
        println!("using &self:\n{:#?}", &self);
    }
}
...
fn main() {
    ...
    println!("{}", car.get_model());
    println!("{}", car.get_year());
    println!("{}", car.get_color());
    println!("{}", car.get_mileage());
    println!("{}", car.get_fuel_type());

    println!("{}", car.get_owner_info());
    println!("{}", car.get_engine_info());

    car.set_color("Red");
    car.set_mileage(2000);
    let mut car2 =
        Car::set_car_info_wo_self("Audi", "A4", 2021, "White", 3000, "Petrol", "Alice", 30);
    car2.set_car_info_with_self("BMW", "M5", 2021, "White", 3000, "Petrol", "Bob", 35);
    car.set_mileage(1000);
